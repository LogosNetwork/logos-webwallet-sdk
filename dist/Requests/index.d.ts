...
export { AdjustFee, AdjustUserStatus, Burn, ChangeSetting, Distribute, ImmuteSetting, Issuance, IssueAdditional, Revoke, Send, TokenSend, UpdateController, UpdateIssuerInfo, WithdrawFee, WithdrawLogos, TokenRequest };
export declare type Request = Send | Issuance | TokenSend | IssueAdditional | ChangeSetting | ImmuteSetting | Revoke | AdjustUserStatus | AdjustFee | UpdateIssuerInfo | UpdateController | Burn | Distribute | WithdrawFee | WithdrawLogos;
export declare type RequestJSON = SendJSON | IssuanceJSON | TokenSendJSON | IssueAdditionalJSON | ChangeSettingJSON | ImmuteSettingJSON | RevokeJSON | AdjustUserStatusJSON | AdjustFeeJSON | UpdateIssuerInfoJSON | UpdateControllerJSON | BurnJSON | DistributeJSON | WithdrawFeeJSON | WithdrawLogosJSON;
